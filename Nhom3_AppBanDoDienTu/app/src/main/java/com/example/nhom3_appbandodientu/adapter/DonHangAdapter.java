...
import com.example.nhom3_appbandodientu.Interface.ItemClickListener;
...
public class DonHangAdapter extends RecyclerView.Adapter<DonHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (donHang.getTrangthai() == 0) {
            holder.trangthai.setText("Trạng thái: Đơn hàng chờ xác nhận");
            holder.huydon.setVisibility(View.VISIBLE);
        } else if (donHang.getTrangthai() == 1) {
            holder.trangthai.setText("Trạng thái: Đơn hàng đã được xác nhận");
            holder.huydon.setVisibility(View.VISIBLE);
        } else if (donHang.getTrangthai() == 2) {
            holder.trangthai.setText("Trạng thái: Đơn hàng đã giao cho đơn vị vận chuyển");
            holder.huydon.setVisibility(View.GONE);
        } else if (donHang.getTrangthai() == 3) {
            holder.trangthai.setText("Trạng thái: Giao hàng thành công");
            holder.huydon.setVisibility(View.GONE);
        } else {
            holder.trangthai.setText("Trạng thái: Đơn hàng đã bị hủy");
            holder.huydon.setVisibility(View.GONE);
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        TextView txtdonhang, txttongtien, trangthai, huydon;
