...
import com.example.nhom3_appbandodientu.Interface.ImageClickListener;
import com.example.nhom3_appbandodientu.R;
import com.example.nhom3_appbandodientu.model.EventBus.TinhTongEvent;
import com.example.nhom3_appbandodientu.model.GioHang;
            ...
            public void onImageClick(View view, int pos, int giatri) {
                ...
                if (giatri == 1) {
                    if (gioHangList.get(pos).getSoluong() > 1) {
                        ...
                        builder.setMessage("Ơ không mua à?");
                        builder.setPositiveButton("Không mua đâu", new DialogInterface.OnClickListener() {
                            @Override
