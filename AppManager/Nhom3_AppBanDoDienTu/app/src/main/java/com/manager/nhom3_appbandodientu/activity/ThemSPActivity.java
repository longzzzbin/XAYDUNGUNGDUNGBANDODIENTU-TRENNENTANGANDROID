...
import com.manager.nhom3_appbandodientu.databinding.ActivityThemspBinding;
...
public class ThemSPActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        stringList.add("Vui lòng chọn loại sản phẩm");
        stringList.add("Loại 1: Điện thoại");
        stringList.add("Loại 2: Laptop");
        stringList.add("Loại 3: Máy tính bảng");
        stringList.add("Loại 4: Âm thanh");
